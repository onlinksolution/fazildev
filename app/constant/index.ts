...
export const EDUCATION = [
  { title: 'Collage', subtitle: 'Wayamba Royal Collage (2018 - 2021)', descrption: 'Enter to Wayamba Royal Collage till end of the Advanced Level Examination.' },
  { title: 'BEng.(Hons) in Software Engineering', subtitle: 'Birmingham City University (2021 onwards)', descrption: `While studying A/L's, I started a degree program in Java Insitute for Advanced Technology for (BEng/ BSc) Software Engineering Degree.` },
]

export const EXPERIANCE = [
  { title: 'Founder', subtitle: 'Onlink Solution (2022 onwards)', descrption: 'Founder at Software Company named Onlink Solutions started from 2022 as employee' },
  { title: 'Web Developer & Software Developer', subtitle: 'Upwork (2021 onwards)', descrption: `While pursuring my degree, I was freelancing at Fiverr in Web Development & Software Application development.` },
]

export const BRANDS = [
  { path: '/company/company-1.png' },
  { path: '/company/company-2.png' },
  { path: '/company/company-3.png' },
  { path: '/company/company-4.jpg' },
]

export const PORTFOLIO = [
  { path: '/portfolio/project-01.jpg', title: 'Liberty Entertainment LOGO Design', description: 'Logo Design for Liberty Entertainment UK LTD.', link: '/' },

  { path: '/portfolio/project-02.jpg', title: 'Chelsea & Callum Production LOGO Design', description: 'Logo Design for Chelsea & Callum Production UK.', link: '/' },
  ...
  { path: '/portfolio/project-11.jpg', title: 'Fears To Fathom Game Website', description: 'Featuring a sleek design and interactive elements, the site captures the eerie essence of the series, providing visitors with detailed insights into the episodes and their spine-tingling narratives.', link: 'http://fearstofathom.vercel.app/' },
]